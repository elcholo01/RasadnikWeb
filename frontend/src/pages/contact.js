          ...
          <div className="container" style={{ display: 'flex', flexWrap: 'wrap', gap: 48, justifyContent: 'center', alignItems: 'flex-start' }}>
            <div style={{ flex: '1 1 260px', minWidth: 220, textAlign: 'center' }}>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <a href="https://maps.app.goo.gl/9jQQNMUU1meWtXk58" target="_blank" rel="noopener noreferrer" style={{ color: '#2e7d32', fontSize: '1.05rem', fontWeight: 600, textDecoration: 'underline', textDecorationColor: 'rgba(46,125,50,0.4)' }}>Pločica, Srbija</a>
              </div>
              <div style={{ marginBottom: 24 }}>
                <div style={{ fontSize: 40, marginBottom: 8 }}>📞</div>
